            ...
            <div class="col-md-4">
                ...
                <div class="block">
                    <ul class="nav nav-tabs nav-tabs-block bg-gray-light" >
                        <li class="nav-item">
                            <a class="nav-link active" href="#status-tab" data-toggle="tab">Status & Categories</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="block-content tab-content">
                        <div class="tab-pane active" id="status-tab" role="tabpanel">
                            ...
                            <div class="form-group">
                                ...
                                <select id="<?php echo $select2_categories['id']?>" name="categories[]" class="form-control" multiple><?php 
                                if(isset($data['categories']) && count($data['categories']) > 0 ){
                                    foreach($data['categories'] AS $row){
                                        echo '<option value="'. $row['category_id'] .'" selected="selected">'. $row['path'] .'</option>';
                                    }
                                }
                                ?></select>
                            </div>
                        ...
                        <div class="tab-pane" id="img-tab" role="tabpanel">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Recomended dimention 840x484 pixel and max filesize 2.0MB</small>
                            </div>
                            <div class="form-group">
                                <label>Caption</label>
