        ...
        <div class="col-12 col-lg-7 col-xl-8 mb-4">
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                <div class="carousel-inner">
                    <?php $i=0; foreach ($latest_news as $val){ $i++?>
                                        ...
                                        <div class="wrap_top">
                                            ...
                                            <div class="wrap_title_top">
                                                <p class="m-0 p-0 d-flex text_14 align-items-center">
                                                    <img src="<?=base_url();?>assets/frontend/images/logo/logo-kategori-2.png" class="mr-1"
                                                    style="width: 20px;" alt="">BerdikariPOLITIK
                                                </p>
                                    ...
                                    <div class="col-12 mt-4 col-sm-6">
                                        <div class="wrap_top">
                                            ...
                                            <div class="wrap_title">
                                                <p class="m-0 p-0 d-flex align-items-center"><img
                                                    src="<?=base_url()?>assets/frontend/images/logo/logo-kategori-2.png" class="mr-1"
                        ...
                        <div class="col-8 col-sm col-md ml-n1 pl-md-3 pl-lg-1 col-lg-8 pl-0">
                            <div class="box_title">
                                ...
                                <p class="m-0 p-0 d-flex text_14 align-items-center"><img
                                    src="<?=base_url()?>assets/frontend/iamges/logo/logo-kategori-2.png" class="mr-1" style="width: 20px;"
    ...
    <div class="row mt-3">
        <div class="col-12 col-md-6 col-lg-4 mb-3">
            <figure class="figure w-100">
                ...
                <p class="m-0 p-0 mb-2 d-flex text_14 align-items-center text-muted"><img
    ...
    <div class="row">
        <div class="col-12 col-sm-6 col-md-8">
            <div class="d-flex justify-content-between">
                ...
                <a href="<?=base_url();?>e_paper" class="text-decoration-none text-primary">Lihat Lainnya <i
                    class="fas fa-chevron-right text-muted ml-3"></i>
                </a>
            </div>
            <div class="row">
                        ...
                        <div class="card border-0 rounded">
                            <div class="card-body box_video">
                                <div class="embed-responsive rounded embed-responsive-16by9">
                                    <iframe id="playVid" class="embed-responsive-item"
                                    src="https://www.youtube.com/embed/<?php echo $val['youtube_id'];?>" allowfullscreen></iframe>
                                </div>
                ...
                <?php $no=0; foreach ($kupas_tv as $val) { $no++?>
                    <?php if ($no > 1) :?>
                        <div class="card_tv_select mb-4">
                            <a href="<?php echo $val['url'];?>" class="text-decoration-none" data-video="<?php echo $val['youtube_id'];?>"
                                data-title="<?php echo $val['title'];?>"
                                data-desc="<?php echo $val['synopsis']; ?>">
                                <div class="d-flex">
