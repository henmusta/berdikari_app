                        ...
                        <div class="wrap_top">
                            ...
                            <div class="wrap_title_top">
                                <p class="m-0 p-0 d-flex text_14 align-items-center">
                                    <img src="<?= base_url()?>assets/frontend/images/logo/logo-kategori-2.png" class="mr-1" style="width: 20px;"
                                    alt="">BerdikariPOLITIK
                                </p>
                ...
                foreach (array_slice($lists, 4) as $val) {
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <figure class="figure w-100">
                            ...
                            <p class="m-0 p-0 mb-2 d-flex text_14 align-items-center text-muted">
                                <img src="<?=base_url();?>assets/frontend/images/logo/logo-kategori-2.png" class="mr-1" style="width: 20px;"
