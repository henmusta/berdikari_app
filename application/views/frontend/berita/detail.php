    ...
    <div class="row">
        <div class="col-12 col-lg-8 mb-5">
            ...
            <figure class="figure w-100">
                <img src="<?php echo $image_large ?>" class="figure-img img-fluid rounded w-100" alt="Berita">
                <figcaption class="figure-caption"><?php echo $media_caption; ?></figcaption>
            </figure>
            <article>
                <?php echo $content; ?>
            </article>
                    ...
                    <div class="card p-1 shadow border-0 detail_news_yt">
                        <div class="card-body">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="rounded" src="https://www.youtube.com/embed/ifLDLFJyiLQ"
            ...
            <div class="box_news mt-4">
                ...
                <div class="row mt-5">
                    <!-- <div class="col-12 w-100">
                        ...
                        <?php echo isset($this->ads['detail_sidebar_5']) ? $this->ads['detail_sidebar_5'] : NULL;?>
                        <?php echo isset($this->ads['detail_sidebar_6']) ? $this->ads['detail_sidebar_6'] : NULL;?>
                        <?php echo isset($this->ads['detail_sidebar_7']) ? $this->ads['detail_sidebar_7'] : NULL;?>
                        <?php echo isset($this->ads['detail_sidebar_8']) ? $this->ads['detail_sidebar_8'] : NULL;?>
                        <?php echo isset($this->ads['detail_sidebar_9']) ? $this->ads['detail_sidebar_9'] : NULL;?>
                        <?php echo isset($this->ads['detail_sidebar_10']) ? $this->ads['detail_sidebar_10'] : NULL;?>
                    </div> -->
                </div>
            </div>
        </div>
