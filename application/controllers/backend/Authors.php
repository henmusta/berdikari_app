...
class Authors extends Backend_Controller {
	...
	public function index(){
		...
		// // $this->template->load('backend/parts/header','backend/dashboard', $data);
		// $this->template->load('backend/parts/header','backend/master/authors/html/datatables', $datatables);
