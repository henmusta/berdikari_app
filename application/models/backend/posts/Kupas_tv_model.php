...
class Kupas_tv_model extends CI_Model {
	...
	public function datatables($request){
		...
		$sql_total_data 	= "SELECT COUNT(post_id) AS total FROM posts WHERE module='kupas-tv';";
		$select 			= "
		SELECT 
		...
		foreach($results->result_array() AS $row){
			...
			$row['actions'] 		= trim('
				<div class="btn-group">
					<a href="kupas-tv/edit/'. $row['post_id'] .'" class="btn btn-sm btn-outline-primary js-tooltip-enabled" data-toggle="tooltip" title="" data-original-title="Edit">
